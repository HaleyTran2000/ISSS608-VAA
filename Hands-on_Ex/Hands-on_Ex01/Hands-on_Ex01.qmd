...
In this chapter, I have learnt the basic principles and essential components of ggplot2. At the same time, I've gained hands-on experience on using these components to plot statistical graphics based on the principle of Layered Grammar of Graphics. Now I am able to apply the essential graphical elements provided by ggplot2 to create elegant and yet functional statistical graphics.
...
Before we get started using ggplot2, it is important to understand the principles of Grammar of Graphics.
